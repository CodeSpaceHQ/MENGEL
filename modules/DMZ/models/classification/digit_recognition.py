...
class digit_recognition:
    ...
    def __init__(self, path):
        ...
        # Set Global variables of testing and training data to our initialized data
        digit_recognition.train = zip_list[:test_int]  # 70% of the data stored in train_data
        digit_recognition.test  = zip_list[-test_int:] # 30% of the data stored in test_data
    ...
    def predict_images(self):
        train_data, test_data = digit_recognition.train, digit_recognition.test   # get testing & training data
        ...
        matrix_test = list(matrix_test_tup) # testing data of images
        digits_test = list(digits_test_tup) # testing data for digits/labels
